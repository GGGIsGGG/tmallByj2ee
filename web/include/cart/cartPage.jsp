...
<script>
	 ...
	 $("#deleteConfirmModal").on("hidden.bs.modal", function(e){
		 if(deleteOrderItem){
			 ...
			 $.post(
					...
					function(result){
						if("success" == result){
							 $("tr.cartProductItemTR[oiid="+deleteOrderItemid + "] img.cartProductItemIfSelected").attr("isDel", "delete");
							 syncSelect();
 ...
 function syncCreateOrderButton(){
		 var selectAny = false;
		 $(".cartProductItemIfSelected").each(function(){
			 if("selectit" == $(this).attr("selectit") && "delete" != $(this).attr("isDel")){
				 selectAny = true;
			 }
		 });
