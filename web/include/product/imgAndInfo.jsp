						...
						$.get(
								...
								function(result){
									if("success" == result){
										...
										$(".addCartButton").attr("disabeld", "disabled");
										$(".addCartButton").css("background-color","lightgray");
										$(".addCartButton").css("border-color", "lightgray");
										$(".addCartButton").css("colocr", "black");
									}
									else{
										alert("未知错误");
									}
...
<div class="imgAndInfo">
	...
	<div class="infoInimgAndInfo">
		...
		<div class="productPrice">
			<div class="juhuasuan">
				<span class="juhuasuanBig">聚划算</span> <span>此商品即将参与聚划算，<span
					class="juhuasuanTime">1天19小时</span>后开始
				</span>
			</div>
			<div class="productPriceDiv">
				<div class="gouwujuanDiv">
					<img alt="gouwujuan" height="16px" src="img/site/gouwujuan.png">
					<span>全天猫通用</span>
				</div>
				...
				<div class="promotionDiv">
					<span class="promotionPriceDesc">促销价格</span> <span
